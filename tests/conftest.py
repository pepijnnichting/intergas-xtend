...
FAKE_DATA = {
    ...
    "7ee6": 5500,   # FIELD_BOILER_TEMP      55.00 °C
    "7e31": 4500,   # FIELD_BOILER_CH_SETPOINT 45.00 °C
    "625b": 5200,   # FIELD_BOILER_SUPPLY_TEMP 52.00 °C
    "7e81": 4700,   # FIELD_BOILER_RETURN_TEMP 47.00 °C
    ...
    "6505": 1800,   # FIELD_SUCTION_LINE_GAS_TEMP 18.00 °C
    "6c26": 2700,   # FIELD_CONDENSOR_GAS_TEMP 27.00 °C
    "6ceb": 2600,   # FIELD_CONDENSOR_LIQUID_TEMP 26.00 °C
    "6cfb": 350,    # FIELD_SUCTION_LINE_OVERHEAT_TEMP 3.50 °C
    "6c33": 650,    # FIELD_DISCHARGE_OVERHEAT_TEMP 6.50 °C
    "6c53": 200,    # FIELD_SUBCOOLING_TEMP 2.00 °C
    "65c1": 3000,   # FIELD_COIL_TEMP 30.00 °C
    # Xtore temperatures
    ...
    "8e7f": 600,    # FIELD_BOILER_DHW_FLOW_RATE 6.00 L/min
    "6579": 1200,   # FIELD_HP_SUCTION_PRESSURE 12.00 bar
    "65b0": 1800,   # FIELD_HP_DISCHARGE_PRESSURE 18.00 bar
    ...
    "65a7": 5000,   # FIELD_COMPRESSOR_FREQUENCY 50.00 Hz
    # Energy (kWh raw × 1)
    ...
    "71a7": 457,    # FIELD_HP_POWERON_HOURS
    "7160": 5,      # FIELD_HP_POWER_CYCLES
    "6a8e": 4,      # FIELD_HP_COMPRESSOR_STARTS
    "6a53": 3,      # FIELD_HP_DEFROST_CYCLES
    "8ef9": 200,    # FIELD_BOILER_CH_HOURS
    "8e37": 150,    # FIELD_BOILER_DHW_HOURS
    "8e00": 50,     # FIELD_BOILER_STARTS
    "8e18": 2,      # FIELD_BOILER_FLAME_LOSS
    "712c": 1,      # FIELD_BOILER_IGNITION_FAILS
