...
from .const import (
    ...
    FIELD_SUCTION_LINE_GAS_TEMP,
    FIELD_CONDENSER_GAS_TEMP,
    FIELD_CONDENSER_LIQUID_TEMP,
    FIELD_SUCTION_LINE_OVERHEAT_TEMP,
    FIELD_DISCHARGE_OVERHEAT_TEMP,
    FIELD_SUBCOOLING_TEMP,
    FIELD_COIL_TEMP,
    FIELD_PRESSURE,
    FIELD_FLOW_RATE,
    ...
    FIELD_DHW_HOURS,
    FIELD_DHW_STARTS,
    FIELD_HP_POWERON_HOURS,
    FIELD_HP_POWER_CYCLES,
    FIELD_HP_COMPRESSOR_STARTS,
    FIELD_HP_DEFROST_CYCLES,
    FIELD_BOILER_CH_HOURS,
    FIELD_BOILER_DHW_HOURS,
    FIELD_BOILER_STARTS,
    FIELD_BOILER_FLAME_LOSS,
...
SENSOR_DESCRIPTIONS: tuple[IntergasXtendSensorEntityDescription, ...] = (
    ...
    IntergasXtendSensorEntityDescription(
        key=FIELD_BOILER_TEMP,
        translation_key="boiler_temperature",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        value_fn=lambda data: _temp(data, FIELD_BOILER_TEMP),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_BOILER_CH_SETPOINT,
        translation_key="boiler_ch_setpoint_temperature",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        value_fn=lambda data: _temp(data, FIELD_BOILER_CH_SETPOINT),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_BOILER_SUPPLY_TEMP,
        translation_key="boiler_supply_temperature",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        value_fn=lambda data: _temp(data, FIELD_BOILER_SUPPLY_TEMP),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_BOILER_RETURN_TEMP,
        translation_key="boiler_return_temperature",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        value_fn=lambda data: _temp(data, FIELD_BOILER_RETURN_TEMP),
    ),
    IntergasXtendSensorEntityDescription(
    ...
    IntergasXtendSensorEntityDescription(
        key=FIELD_SUCTION_LINE_GAS_TEMP,
        translation_key="suction_line_gas_temperature",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda data: _temp(data, FIELD_SUCTION_LINE_GAS_TEMP),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_CONDENSER_GAS_TEMP,
        translation_key="condenser_gas_temperature",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda data: _temp(data, FIELD_CONDENSER_GAS_TEMP),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_CONDENSER_LIQUID_TEMP,
        ...
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda data: _temp(data, FIELD_CONDENSER_LIQUID_TEMP),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_SUCTION_LINE_OVERHEAT_TEMP,
        translation_key="suction_line_overheat_temperature",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda data: _temp(data, FIELD_SUCTION_LINE_OVERHEAT_TEMP),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_DISCHARGE_OVERHEAT_TEMP,
        translation_key="discharge_overheat_temperature",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda data: _temp(data, FIELD_DISCHARGE_OVERHEAT_TEMP),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_SUBCOOLING_TEMP,
        translation_key="subcooling_temperature",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda data: _temp(data, FIELD_SUBCOOLING_TEMP),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_COIL_TEMP,
        ...
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda data: _temp(data, FIELD_COIL_TEMP),
    ),
    IntergasXtendSensorEntityDescription(
        key="delta_t",
    ...
    IntergasXtendSensorEntityDescription(
        key=FIELD_BOILER_DHW_FLOW_RATE,
        translation_key="boiler_hot_water_flow_rate",
        native_unit_of_measurement=UnitOfVolumeFlowRate.LITERS_PER_MINUTE,
        device_class=SensorDeviceClass.VOLUME_FLOW_RATE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        value_fn=lambda data: _int16(data, FIELD_BOILER_DHW_FLOW_RATE, 0.01),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_HP_SUCTION_PRESSURE,
        translation_key="heatpump_suction_pressure",
        native_unit_of_measurement=UnitOfPressure.BAR,
        device_class=SensorDeviceClass.PRESSURE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        entity_registry_enabled_default=False,
        value_fn=lambda data: _int16(data, FIELD_HP_SUCTION_PRESSURE, 0.01),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_HP_DISCHARGE_PRESSURE,
        translation_key="heatpump_discharge_pressure",
        native_unit_of_measurement=UnitOfPressure.BAR,
        device_class=SensorDeviceClass.PRESSURE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=2,
        entity_registry_enabled_default=False,
        value_fn=lambda data: _int16(data, FIELD_HP_DISCHARGE_PRESSURE, 0.01),
    ),
    # --- Power --------------------------------------------------------------
    IntergasXtendSensorEntityDescription(
    ...
    IntergasXtendSensorEntityDescription(
        key=FIELD_COMPRESSOR_FREQUENCY,
        ...
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda data: _int16(data, FIELD_COMPRESSOR_FREQUENCY, 0.01),
    ),
    # --- Energy totals ------------------------------------------------------
    IntergasXtendSensorEntityDescription(
    ...
    IntergasXtendSensorEntityDescription(
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.get(FIELD_HP_POWERON_HOURS),
    ),
    IntergasXtendSensorEntityDescription(
    ...
    IntergasXtendSensorEntityDescription(
        key=FIELD_HP_POWER_CYCLES,
        translation_key="power_cycles",
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.get(FIELD_HP_POWER_CYCLES),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_HP_COMPRESSOR_STARTS,
        translation_key="compressor_starts",
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.get(FIELD_HP_COMPRESSOR_STARTS),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_HP_DEFROST_CYCLES,
        translation_key="defrost_cycles",
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.get(FIELD_HP_DEFROST_CYCLES),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_BOILER_CH_HOURS,
        translation_key="boiler_heating_hours",
        native_unit_of_measurement=UnitOfTime.HOURS,
        device_class=SensorDeviceClass.DURATION,
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.get(FIELD_BOILER_CH_HOURS),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_BOILER_DHW_HOURS,
        translation_key="boiler_hot_water_hours",
        native_unit_of_measurement=UnitOfTime.HOURS,
        device_class=SensorDeviceClass.DURATION,
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.get(FIELD_BOILER_DHW_HOURS),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_BOILER_STARTS,
        translation_key="boiler_starts",
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.get(FIELD_BOILER_STARTS),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_BOILER_FLAME_LOSS,
        translation_key="boiler_flame_loss_count",
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.get(FIELD_BOILER_FLAME_LOSS),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_BOILER_IGNITION_FAILS,
        translation_key="boiler_ignition_fail_count",
        state_class=SensorStateClass.TOTAL_INCREASING,
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda data: data.get(FIELD_BOILER_IGNITION_FAILS),
    ),
    IntergasXtendSensorEntityDescription(
