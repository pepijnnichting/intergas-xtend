...
from .const import (
    ...
    FIELD_CONDENSOR_GAS_TEMP,
    FIELD_CONDENSOR_LIQUID_TEMP,
...
SENSOR_DESCRIPTIONS: tuple[IntergasXtendSensorEntityDescription, ...] = (
    ...
    IntergasXtendSensorEntityDescription(
        key=FIELD_CONDENSOR_GAS_TEMP,
        translation_key="condensor_gas_temperature",
        native_unit_of_measurement=UnitOfTemperature.CELSIUS,
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda data: _temp(data, FIELD_CONDENSOR_GAS_TEMP),
    ),
    IntergasXtendSensorEntityDescription(
        key=FIELD_CONDENSOR_LIQUID_TEMP,
        ...
        suggested_display_precision=1,
        entity_registry_enabled_default=False,
        value_fn=lambda data: _temp(data, FIELD_CONDENSOR_LIQUID_TEMP),
    ),
    IntergasXtendSensorEntityDescription(
