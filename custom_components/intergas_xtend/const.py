...
FIELD_CONDENSER_GAS_TEMP = "6c26"   # condenser refrigerant gas temperature
FIELD_CONDENSER_LIQUID_TEMP = "6ceb"   # condenser refrigerant liquid temperature
...
FIELD_DHW_GAS_METER           = "71aa"   # DHW gas meter, m³, ×0.0001
...
ALL_FIELDS = ",".join([
    ...
    FIELD_SUCTION_LINE_GAS_TEMP, FIELD_CONDENSER_GAS_TEMP, FIELD_CONDENSER_LIQUID_TEMP,
